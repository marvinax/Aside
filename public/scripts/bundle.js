		...
		render: function() {
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", {key: "desc"+this.props.key, style: {opacity:this.state.opacity}, className: "descript-box"}, React.createElement("img", {width: "100%", src: "./icons/weixin.svg"})), 
